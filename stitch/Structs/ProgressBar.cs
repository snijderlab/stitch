    ...
    public class ProgressBar : IDisposable {
        ...
        void Draw(bool clear = true) {
            if (free && !Off) {
                ...
                Console.Write($"{stem}>{empty}{tail}\r"); // The last \r is a carriage return to make sure the cursor stays on this line and the drawing redraws over itself every update.
