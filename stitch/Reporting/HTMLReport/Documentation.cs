namespace HTMLNameSpace
{
    ...
    public class HTMLHelp
    {
        ...
        public const string Spectrum = "The raw spectrum of this peptide. The fragments are coloured according to ion type (see legend). Any peaks with a star '*' as text can be hovered over to see the full details, first the ion type second the mass shift type. By hovering over the amino acids in the peptide the corresponding peaks are highlighted. By toggling the 'Unassigned' and 'Ion' labels you can turn these features on or off in the plot. By dragging in the spectrum you can zoom in to a specific part of the spectrum and use 'Zoom Out' to get back to the original zoom level.";
