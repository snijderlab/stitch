...
namespace Stitch {
    namespace RunParameters {
        ...
        public class FullRunParameters {
            ...
            /// <summary> The input for this run </summary> 
            public RunParameters.InputData Input = new InputData();

            /// <summary> The parameters for the template matching </summary> 
            public TemplateMatchingParameter TemplateMatching = null;

            /// <summary> The recombine parameters (if given). </summary> 
            ...
            /// <summary> To save the original batchfile </summary> 
