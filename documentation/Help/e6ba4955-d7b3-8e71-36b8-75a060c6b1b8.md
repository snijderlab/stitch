# Assembler.GetCondensedNodeIdentifier Method 
...
**C#**<br />
``` C#
private string GetCondensedNodeIdentifier(
	int index
)
```
...
#### Parameters
&nbsp;<dl><dt>index</dt><dd>Type: <a href="http://msdn2.microsoft.com/en-us/library/td2s409d" target="_blank">System.Int32</a><br />The index in the condensed graph of the condesend node.</dd></dl>
